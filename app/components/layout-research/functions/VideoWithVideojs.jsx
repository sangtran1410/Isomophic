...
export default class VideoWithVideojs extends Component {
	...
	state = {
		...
		urls: [
			...
			'http://dsys1.videodownload.worldnow.com/WNOW_120620171454084130AA.mp4',
			'http://localhost:9000/public/oceans.mp4',
			'http://localhost:9000/public/img1.mp4',
			'http://localhost:9000/public/img2.mp4'
		],
		...
		id: 'video_js',
		srcTracks: [
			{ srclang: 'zh', label: 'Chinese', isDefault: false, src: 'https://dotsub.com/media/5d5f008c-b5d5-466f-bb83-2b3cfa997992/c/chi_hans/vtt'},
			{ srclang: 'en', label: 'English', isDefault: false, src: 'https://dotsub.com/media/5d5f008c-b5d5-466f-bb83-2b3cfa997992/c/eng/vtt'},
			{ srclang: 'es', label: 'Spanish', isDefault: false, src: 'https://dotsub.com/media/5d5f008c-b5d5-466f-bb83-2b3cfa997992/c/spa/vtt'},
			{ srclang: 'fr', label: 'French', isDefault: false, src: 'https://dotsub.com/media/5d5f008c-b5d5-466f-bb83-2b3cfa997992/c/fre_ca/vtt'}
		],
	...
	renderVideo({ videoKey = 'urls', type = 'mp4'} = '') {
		const { style, [videoKey]: urls, srcTracks = [], id, type: typeLink } = this.state
		return (
			<div className="featured_Video" >
				...
				<video
					...
					<source src={urls[0]} type={typeLink} label='SD' res='480' />
					<source src={urls[0]} type={typeLink} label='HD' res='1080'/>
					<source src={urls[0]} type={typeLink} label='phone' res='144'/>
					<source src={urls[0]} type={typeLink} label='4k' res='2160'/>
					...
					{srcTracks && srcTracks.length > 0 &&
						srcTracks.map((obj, i) => {
							const { src, srclang, label, isDefault } = obj
							return (
								<track key={`track-${i}`} kind='captions' src={src} srcLang={srclang} label={label} default={isDefault} />
							)
						})
					}
				</video>
	...
	render() {
		...
		return (
			<div className="container">
				{this.renderVideo({ videoKey: 'urls' })}
				<hr />
				<div>
